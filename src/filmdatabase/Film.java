...
public class Film extends DBConn{
	...
	public void leggTilSkuespiller(String tittel, int lengde, int arstall, String dato, String beskrivelse, String format) {
		Statement state = null;
		try {
			String query = "INSERT INTO filmdatabase.skuespiller "
					+ "VALUES (DEFAULT,'"+tittel+"', '"+lengde+"', '"+arstall+"','"+dato+"','"+beskrivelse+"','" +format+"')"; 
			state = conn.createStatement();
			state.executeUpdate(query);
		} catch (SQLException e) {
